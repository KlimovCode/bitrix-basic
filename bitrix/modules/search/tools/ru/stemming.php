...
function stemming_ru($word, $flags = 0)
{
	...
	static $STEMMING_RU_EX = array(
		...
		"Р‘Р«Р›Р¬"=>"Р‘Р«Р›Р¬",
		"РњР•РќР®"=>"РњР•РќР®",
		"Р“Р РђРќРђРў"=>"Р“Р РђРќРђРў",
		"Р“Р РђРќР�Рў"=>"Р“Р РђРќР�Рў",
		"РўР•Р РњР�РќРђР›"=>"РўР•Р РњР�РќРђР›",
		"Р�Р›Р�"=>"Р�Р›Р�",
		"Р РЈРљРђР’"=>"Р РЈРљРђР’",
		"РџР Р�Р•Рњ"=>"РџР Р�Р•Рњ",
		"РћРҐР РђРќРђ"=>"РћРҐР РђРќ",
		"Р—РђР–Р�Рњ"=>"Р—РђР–Р�Рњ",
	);
	...
	if(preg_match("/(РћРЎРўР¬|РћРЎРў)$/".BX_UTF_PCRE_MODIFIER, $rv))
	{
		...
		if($R2 < $rv_len)
			$R2++;
		//"РћРЎРўР¬", "РћРЎРў"
		if((mb_substr($rv, -4) == "РћРЎРўР¬") && ($rv_len >= ($R2+4)))
			$rv = mb_substr($rv, 0, $rv_len - 4);
		elseif((mb_substr($rv, -3) == "РћРЎРў") && ($rv_len >= ($R2+3)))
